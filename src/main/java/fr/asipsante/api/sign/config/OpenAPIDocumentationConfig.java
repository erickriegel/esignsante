 ...
 */
@javax.annotation.Generated(value = "org.openapitools.codegen.languages.SpringCodegen", date = "2019-11-19T15:01:00.313+01:00[Europe/Paris]")
...
public class OpenAPIDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("ASIP-Sign").description(
                ...
                .license("").licenseUrl("http://unlicense.org").termsOfServiceUrl("").version("2.0.0.7")
