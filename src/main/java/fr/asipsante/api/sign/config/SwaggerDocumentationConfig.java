...
public class SwaggerDocumentationConfig {
    ...
    ApiInfo apiInfo() {
        return new ApiInfoBuilder().title("ASIP-Sign").description(
                ...
                .version("2.0.0.0").contact(new Contact("Asip santé", "https://esante.gouv.fr", "support@asipsante.fr"))
                .build();
    }
    ...
    public Docket customImplementation() {
        return new Docket(DocumentationType.SWAGGER_2).useDefaultResponseMessages(false).select()
                .apis(RequestHandlerSelectors.basePackage("fr.asipsante.api.sign.ws.api")).build()
