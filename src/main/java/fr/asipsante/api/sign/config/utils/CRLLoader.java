...
public class CRLLoader {
    ...
    class CRLFileLoader extends CRLLoaderImpl {
         ...
         * @throws GeneralSecurityException GeneralSecurityException
         */
        private Collection<X509CRL> loadFromURI(final CertificateFactory cf, final URI remoteURI) throws GeneralSecurityException {
         ...
         */
        private X509CRL loadFromStream(final CertificateFactory cf, final InputStream is) throws IOException, CRLException {
