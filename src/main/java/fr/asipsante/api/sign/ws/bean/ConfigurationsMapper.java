...
public class ConfigurationsMapper {
    ...
    public static List<ConfSign> mapSignConfig(Map<String, SignatureParameters> signParametersMap)
        ...
        for (Map.Entry<String, SignatureParameters> entry : signParametersMap.entrySet()) {
    ...
    public static List<ConfProof> mapProofConfig(Map<String, SignatureParameters> signProofParametersMap)
        ...
        for (Map.Entry<String, SignatureParameters> entry : signProofParametersMap.entrySet()) {
    ...
    public static List<ConfVerifCert> mapVerifCertConfig(
        ...
        for (Map.Entry<String, CertificateValidationParameters> entry : verifCertParametersMap.entrySet()) {
    ...
    public static List<ConfVerifSign> mapVerifSignConfig(
        ...
        for (Map.Entry<String, SignatureValidationParameters> entry : verifSignParametersMap.entrySet()) {
