...
public class ValidationApiDelegateImpl extends ApiDelegate implements ValidationApiDelegate {
     ...
     */
    private ResponseEntity<AsipValidationReportWithProof> validateDigitalSignatureWithProof(
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipValidationReportWithProof> validateWithProof(
     ...
     */
    @Override
    public ResponseEntity<AsipValidationReportWithProof> verifSignatureXMLdsigWithProof(
     ...
     */
    @Override
    public ResponseEntity<AsipValidationReportWithProof> verifSignatureXadesWithProof(
            final Long idVerifSignConf, final MultipartFile doc, final String requestId, final String proofTag,
            final String applicantId, final Long idProofConf) {
        Version wsVersion = DEFAULT_VERSION;
        try {
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipValidationReport> validateDigitalSignature(
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipValidationReport> validate(
     ...
     */
    @Override
    public ResponseEntity<AsipValidationReport> verifSignatureXMLdsig(final Long idVerifSignConf,
     ...
     */
    @Override
    public ResponseEntity<AsipValidationReport> verifSignatureXades(final Long idVerifSignConf,
                                                                    final MultipartFile doc) {
     ...
     */
    @Override
    public ResponseEntity<AsipValidationReportWithProof> verifCertificatWithProof(
        ...
        if (acceptHeader.isPresent() && acceptHeader.get().contains(WsVars.HEADER_TYPE.getVar())) {
            if (doc == null || proofParamsMissing(proofParameters)) {
                ...
                final CertificateValidationParameters certVerifParams = ConfigurationLoader.loadCertVerifConf(
                        verifConf.get());
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipValidationReportWithProof> validateCertWithProof(
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipValidationReport> validateCert(
            final MultipartFile doc, final CertificateValidationParameters certValidationParameters) {
     ...
     */
    private AsipValidationReport populateResultSign(final List<ErreurSignature> erreursSignature,
     ...
     */
    private AsipValidationReportWithProof populateResultSignWithProof(
     ...
     * @return the rapport verif with proof
     */
    private AsipValidationReportWithProof populateResultVerifCertWithProof(
