...
public class ValidationApiDelegateImpl extends ApiDelegate implements ValidationApiDelegate {
    ...
    private ResponseEntity<AsipValidationReportWithProof> validateDigitalSignatureWithProof(Long idVerifSignConf,
            MultipartFile doc, ProofParameters proofParameters, Long idProofConf, boolean isXades) {
        ...
        if (acceptHeader.isPresent() && acceptHeader.get().contains(WsVars.HEADER_TYPE.getVar())) {
            if (doc == null || idVerifSignConf == null || proofParamsMissing(proofParameters) || idProofConf == null) {
                ...
                if (signValidationParameters == null || signProofParams == null) {
                    ...
                    re = validateWithProof(doc, proofParameters, idProofConf, isXades, signValidationParameters,
                            signProofParams);
                }
            }
        }
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipValidationReportWithProof> validateWithProof(MultipartFile doc,
            ProofParameters proofParameters, Long idProofConf, boolean isXades,
        ...
        try {
            ...
            final HttpStatus status = SignWsUtils.checkCertificate(
                    params.getSignatureConfigurations().get(idProofConf.toString()), serviceCaCrl.getCacrlWrapper());
        ...
        if (acceptHeader.isPresent() && acceptHeader.get().contains(WsVars.HEADER_TYPE.getVar())) {
            if (doc == null || idVerifSignConf == null) {
                ...
                if (signValidationParameters == null) {
                    ...
                    re = validate(doc, isXades, signValidationParameters);
                }
            }
        }
        return re;
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipValidationReport> validate(MultipartFile doc, boolean isXades,
    ...
    private RapportValidationSignature genSignVerifReport(MultipartFile doc, boolean isXades,
        ...
        // Validation de la signature du document
        RapportValidationSignature rapportVerifSignAsip;
        if (isXades) {
    ...
    public ResponseEntity<AsipValidationReportWithProof> verifCertificatWithProof(Long idVerifCertConf,
        ...
        if (acceptHeader.isPresent() && acceptHeader.get().contains(WsVars.HEADER_TYPE.getVar())) {
            if (doc == null || idVerifCertConf == null || proofParamsMissing(proofParameters) || idProofConf == null) {
                re = new ResponseEntity<>(HttpStatus.BAD_REQUEST);
            } else {
                ...
                if (certValidationParameters == null || signProofParams == null) {
                    re = new ResponseEntity<>(HttpStatus.NOT_FOUND);
                } else {
                    re = validateCertWithProof(doc, idProofConf, certValidationParameters, signProofParams,
                            proofParameters);
                }
            }
        }
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipValidationReportWithProof> validateCertWithProof(MultipartFile doc, Long idProofConf,
        ...
        if (acceptHeader.isPresent() && acceptHeader.get().contains(WsVars.HEADER_TYPE.getVar())) {
            if (doc == null || idVerifCertConf == null) {
                ...
                if (certValidationParameters == null) {
                    ...
                    re = validateCert(doc, certValidationParameters);
                }
            }
        }
        return re;
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipValidationReport> validateCert(MultipartFile doc,
    ...
    private RapportValidationCertificat createRapportValidationCertificat(MultipartFile doc,
        ...
        RapportValidationCertificat rapportVerifCertAsip;
