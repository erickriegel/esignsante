...
public class Parameters {
    ...
    public Conf getConfigs() throws AsipSignServerException {
        ...
        final List<ConfVerifCert> confsVerifCert =
                ConfigurationsMapper.mapVerifCertConfig(certificateValidationConfigurations);
        ...
        final List<ConfVerifSign> confsVerifSign =
                ConfigurationsMapper.mapVerifSignConfig(signatureValidationConfigurations);
