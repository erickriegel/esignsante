...
public class Parameters {
    ...
    /**
     * Liste des secrets qui donnent accès à une conf de signature identifiée par
     * l'Id de conf de signature.
     */
    private Map<String, String[]> signatureSecrets = new HashMap<>();

    /**
     * Liste des configuration de preuve de signature identifiées par l'Id de
     * signature.
     */
    private Map<String, String> signatureProofId = new HashMap<>();
    ...
    /**
     * Gets the signature secrets.
     *
     * @return the signature secrets
     */
    public Map<String, String[]> getSignatureSecrets() {
        return signatureSecrets;
    }

    /**
     * Sets the signature secrets.
     *
     * @param signatureSecrets the signature secrets
     */
    public void setSignatureSecrets(Map<String, String[]> signatureSecrets) {
        this.signatureSecrets = signatureSecrets;
    }

    /**
     * Gets the signature proof.
     *
     * @return the signature proof
     */
    public Map<String, String> getSignatureProofId() {
        return signatureProofId;
    }

    /**
     * Sets the signature proof.
     *
     * @param signatureProof the signature proof
     */
    public void setSignatureProofId(Map<String, String> signatureProof) {
        this.signatureProofId = signatureProof;
    }
