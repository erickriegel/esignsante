...
public class ConfigurationMapper {
    ...
    public ConfigurationMapper(final List<SignatureConf> signature, final List<ProofConf> proof,
                               final List<SignVerifConf> signatureVerification, final List<CertVerifConf> certificateVerification) {
     ...
     */
    static {
        try (final InputStream is = Thread.currentThread().getContextClassLoader().getResourceAsStream("rules.properties")) {
