...
import fr.asipsante.api.sign.ws.model.*;
...
import fr.asipsante.api.sign.ws.model.ConfProof.SignaturePackagingForProofEnum;
...
public class ConfigurationMapper {
     ...
     */
    public ConfigurationMapper(List<SignatureConf> signature, List<ProofConf> proof,
                               List<SignVerifConf> signatureVerification, List<CertVerifConf> certificateVerification) {
     ...
     */
    public Conf getConfigs() throws CertificateException, IOException, IllegalAccessException {
    ...
    private List<ConfSign> mapSignConfig() throws CertificateException, IOException {
        ...
        for (final SignatureConf signConf : signature) {
            ...
            config.canonicalisationAlgorithm(CanonicalisationAlgorithmEnum.fromValue(signConf.getCanonicalisationAlgorithm()));
     ...
     * @return the list
     */
    public List<ConfVerifSign> mapVerifSignConfig() throws IllegalAccessException {
     ...
     * @throws IOException input stream exception
     */
    private static String getDn(String certificate) throws CertificateException, IOException {
