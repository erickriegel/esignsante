...
public class ConfigurationsLoader {
    ...
    public void load(Parameters paramsList) {
        ...
        for (String verifSignId : verifSignIds) {
            final String verifPathvalue =
                    prop.getProperty("config.verifsign." + verifSignId + WsVars.PROPS_PATH.getVar());
        ...
        for (String verifCertId : verifCertIds) {
            final String certPathValue =
                    prop.getProperty("config.verifcert." + verifCertId + WsVars.PROPS_PATH.getVar());
