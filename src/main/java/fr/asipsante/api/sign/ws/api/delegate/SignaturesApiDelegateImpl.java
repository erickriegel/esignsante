...
public class SignaturesApiDelegateImpl extends ApiDelegate implements SignaturesApiDelegate {
    ...
    private ResponseEntity<AsipSignatureReportWithProof> digitalSignatureWithProof(Long idSignConf, MultipartFile doc,
        ...
        if (acceptHeader.isPresent() && acceptHeader.get().contains(WsVars.HEADER_TYPE.getVar())) {
            if (signParamsPresent(idSignConf, doc, idVerifSignConf) && proofParamsPresent(requestId, proofTag, applicantId, idProofConf)) {
     ...
     * @return boolean
     */
    private boolean signParamsPresent(Long idSignConf, MultipartFile doc, Long idVerifSignConf) {
     ...
     * @return boolean
     */
    private boolean proofParamsPresent(String requestId, String proofTag, String applicantId, Long idProofConf) {
        return requestId == null || proofTag == null || applicantId == null || idProofConf == null;
    }
