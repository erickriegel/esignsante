...
public class SignaturesApiDelegateImpl extends ApiDelegate implements SignaturesApiDelegate {
     ...
     */
    private ResponseEntity<AsipSignatureReportWithProof> digitalSignatureWithProof(final String secret, final Long idSignConf,
                                                                                   final MultipartFile doc, final Long idVerifSignConf, final ProofParameters proofParameters, final boolean isXades) {
        ...
        if (!signConf.isPresent() || !verifConf.isPresent()) {
            ...
            if (acceptHeader.isPresent() && acceptHeader.get().contains(WsVars.HEADER_TYPE.getVar())) {
                if (signParamsMissing(idSignConf, doc, idVerifSignConf) || proofParamsMissing(proofParameters)) {
                    ...
                    final SignatureParameters signParams = ConfigurationLoader.loadSignConf(signConf.get());
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipSignatureReportWithProof> signWithProof(final MultipartFile doc,
                                                                       final ProofParameters proofParameters, final boolean isXades, final SignatureParameters signParams,
                                                                       final SignatureValidationParameters signValidationParameters, final SignatureParameters signProofParams) {

        ResponseEntity<AsipSignatureReportWithProof> re;
     ...
     */
    @Override
    public ResponseEntity<AsipSignatureReportWithProof> signatureXMLdsigWithProof(final Long idSignConf, final MultipartFile doc,
                                                                                  final Long idVerifSignConf, final String requestId, final String proofTag, final String applicantId, final String secret) {
     ...
     */
    @Override
    public ResponseEntity<AsipSignatureReportWithProof> signatureXadesWithProof(final Long idSignConf, final MultipartFile doc,
                                                                                final Long idVerifSignConf, final String requestId, final String proofTag, final String applicantId, final String secret) {
        Version wsVersion = DEFAULT_VERSION;
        try {
            wsVersion = new Version(version);
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipSignatureReport> digitalSignature(final String secret, final Long idSignConf, final MultipartFile doc,
     ...
     * @return the response entity
     */
    private ResponseEntity<AsipSignatureReport> sign(final SignatureParameters signParams, final MultipartFile doc, final boolean isXades) {
        ResponseEntity<AsipSignatureReport> re;
        ...
        try {
            ...
            if (status != HttpStatus.CONTINUE) {
                ...
                final AsipSignatureReport rapport = populateResultSign(rapportSignature.getListeErreurSignature(),
     ...
     */
    @Override
    public ResponseEntity<AsipSignatureReport> signatureXMLdsig(final Long idSignConf, final MultipartFile doc, final String secret) {
     ...
     */
    @Override
    public ResponseEntity<AsipSignatureReport> signatureXades(final Long idSignConf, final MultipartFile doc, final String secret) {
     ...
     */
    private AsipSignatureReport populateResultSign(final List<ErreurSignature> erreursSignature, final String signedDocument) {
     ...
     */
    private AsipSignatureReportWithProof populateResultSignWithProof(final List<ErreurSignature> erreursSignature,
                                                                     final List<MetaDatum> metadata, final boolean isValide, final String signedDocument, final String preuve) {
