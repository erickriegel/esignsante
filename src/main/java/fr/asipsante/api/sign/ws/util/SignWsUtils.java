    ...
    public static HttpStatus checkCertificate(
        ...
        try {
            if (signParams != null) {
                ...
                final ICertificateValidationService certificatevValidationService =
                        new CertificateValidationServiceImpl();
                ...
                for (X509Certificate cert : certificats) {
                    final RapportValidationCertificat rapportValidationCert = certificatevValidationService
