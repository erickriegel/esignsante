...
public class ConfigurationLoader {
     ...
     */
    public static SignatureParameters loadSignConf(SignatureConf signConf) {
        ...
        String ksPass = RandomStringUtils.randomAscii(ASCII_COUNT);
     ...
     * @return the signature parameters
     */
    public static SignatureParameters loadProofSignConf(ProofConf proofConf) {
        final SignatureParameters params = new SignatureParameters();
     ...
     */
    public static SignatureValidationParameters loadSignVerifConf(SignVerifConf signVerifConf) {
     ...
     */
    public static CertificateValidationParameters loadCertVerifConf(CertVerifConf certVerifConf) {
     ...
     */
    private static File generateKsFile(String certificate, String privateKey, String ksPass) throws GeneralSecurityException, IOException {
     ...
     */
    private static byte[] convertToDER(String pemContent) {
