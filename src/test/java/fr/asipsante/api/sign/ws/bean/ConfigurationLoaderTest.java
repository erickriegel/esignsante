...
public class ConfigurationLoaderTest {
    ...
    public static void init() throws Exception {
        String wsConfPathGood = String.valueOf(Paths.get(Paths.get(Objects.requireNonNull(Thread.currentThread()
    ...
    public void configLoadSignConfTest() {
        ...
        SignatureParameters signParams = ConfigurationLoader.loadSignConf(conf.getSignatureById("1").get());
        ...
        assertTrue("Le fichier tamporair crée pour le KS store n'a pas pu être supprimé",
    ...
    public void configLoadProofSignConfTest() {
        ...
        SignatureParameters signProofParams = ConfigurationLoader.loadProofSignConf(conf.getProofById("1").get());
