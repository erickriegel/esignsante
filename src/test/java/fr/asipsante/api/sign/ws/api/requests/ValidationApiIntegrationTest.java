...
public class ValidationApiIntegrationTest {
    ...
    public void init() throws Exception {
        doc = new MockMultipartFile("file",
                Thread.currentThread().getContextClassLoader()
                        .getResourceAsStream("TOM_FICHIER.xml"));
    }
    ...
    public void verifSignXMLdsigTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/validation/signatures/xmldsigwithproof").file(doc)
    ...
    public void verifSignXadesBaselineBTest() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/validation/signatures/xadesbaselinebwithproof")
                .file(doc).param("idVerifSignConf", "1")
    ...
    public void verifSignXadesExpireTest() throws Exception {
        MockMultipartFile document = new MockMultipartFile("file",
                Thread.currentThread().getContextClassLoader()
                        .getResourceAsStream("XADESCertExpire.xml"));
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/validation/signatures/xadesbaselineb")
                .file(document).param("idVerifSignConf", "1")
                .accept("application/json")).andExpect(status().isOk())
                .andDo(print());
    }
    ...
    public void verifCertificatExpireTest() throws Exception {
        MockMultipartFile cert = new MockMultipartFile("file",
                Thread.currentThread().getContextClassLoader()
                        .getResourceAsStream(
                                "rpps.tra.henix.asipsante.fr-sign-expire.pem"));
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/validation/certificats").file(cert)
    ...
    public void verifSignXMLdsigTestBadFile() throws Exception {
        doc = new MockMultipartFile("file",
                Thread.currentThread().getContextClassLoader()
                        .getResourceAsStream("TOM_FICHIER_bad.xml"));
    ...
    public void verifSignXmldsigDocAltereTest() throws Exception {
        MockMultipartFile document = new MockMultipartFile("file", Thread
                .currentThread().getContextClassLoader().getResourceAsStream(
                        "Signature_Dsig_enveloppee_document_modifie.xml"));
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/validation/signatures/xadesbaselineb")
                .file(document).param("idVerifSignConf", "1")
                .accept("application/json")).andExpect(status().isOk())
    ...
    public void verifSignXadesBadACTest() throws Exception {
        MockMultipartFile document = new MockMultipartFile("file",
                Thread.currentThread().getContextClassLoader()
                        .getResourceAsStream("SignatureCA-PERSONNE.xml"));
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/validation/signatures/xadesbaselineb")
                .file(document).param("idVerifSignConf", "1")
                .accept("application/json")).andExpect(status().isOk())
    ...
    public void verifCertificatTest() throws Exception {
        MockMultipartFile cert = new MockMultipartFile("file", Thread
                .currentThread().getContextClassLoader().getResourceAsStream(
                        "asip-p12-EL-TEST-ORG-SIGN-20181116-141712.pem"));
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/validation/certificats").file(cert)
                .param("idVerifCertConf", "1").accept("application/json"))
                .andExpect(status().isOk()).andDo(print());
    ...
    public void verifCertificatBadACTest() throws Exception {
        MockMultipartFile cert = new MockMultipartFile("file",
                Thread.currentThread().getContextClassLoader()
                        .getResourceAsStream("classe4.pem"));
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/validation/certificats").file(cert)
                .param("idVerifCertConf", "1").accept("application/json"))
                .andExpect(status().isOk()).andDo(print());
    ...
    public void verifCertificatDERTest() throws Exception {
        MockMultipartFile cert = new MockMultipartFile("file", Thread
                .currentThread().getContextClassLoader().getResourceAsStream(
                        "asip-p12-EL-TEST-ORG-SIGN-20181116-141712.der"));
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/validation/certificats").file(cert)
                .param("idVerifCertConf", "1").accept("application/json"))
                .andExpect(status().isOk()).andDo(print());
    ...
    public void verifCertificatBadCADERTest() throws Exception {
        MockMultipartFile cert = new MockMultipartFile("file",
                Thread.currentThread().getContextClassLoader()
                        .getResourceAsStream("2600301752-Auth.crt"));
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/validation/certificats").file(cert)
                .param("idVerifCertConf", "1").accept("application/json"))
                .andExpect(status().isOk()).andDo(print());
