...
public class ConfigurationsApiIntegrationTest {
    ...
    public void configurationsGetTest() throws Exception {
        ...
        final String expectedBody = "{\"signature\":[{\"idSignConf\":1,\"description\":\"Scheduling Test.\",\"signaturePackaging\":\"ENVELOPING\",\"digestAlgorithm\":\"SHA512\",\"canonicalisationAlgorithm\":\"http://www.w3.org/2001/10/xml-exc-c14n#\",\"dn\":\"CN=testsign.test.asipsante.fr, OU=318751275100020, O=ASIP-SANTE, ST=Paris (75), C=FR\"},{\"idSignConf\":2,\"description\":\"Fichier de configuration de Ioanna pour les signatures de documents.\",\"signaturePackaging\":\"ENVELOPING\",\"digestAlgorithm\":\"SHA512\",\"canonicalisationAlgorithm\":\"http://www.w3.org/2001/10/xml-exc-c14n#\",\"dn\":\"CN=asipsign.flux.henix.asipsante.fr, OU=318751275100020, O=ASIP-SANTE, ST=Paris (75), C=FR\"},{\"idSignConf\":3,\"description\":\"Fichier de configuration de Ioanna pour les signatures de documents.\",\"signaturePackaging\":\"ENVELOPED\",\"digestAlgorithm\":\"SHA512\",\"canonicalisationAlgorithm\":\"http://www.w3.org/2001/10/xml-exc-c14n#\",\"dn\":\"CN=asipsign.flux.henix.asipsante.fr, OU=318751275100020, O=ASIP-SANTE, ST=Paris (75), C=FR\"},{\"idSignConf\":5,\"description\":\"Scheduling Test.\",\"signaturePackaging\":\"ENVELOPING\",\"digestAlgorithm\":\"SHA512\",\"canonicalisationAlgorithm\":\"http://www.w3.org/2001/10/xml-exc-c14n#\",\"dn\":\"CN=\\\"rpps.tra.henix;asipsante.fr\\\", OU=318751275100020, O=ASIP-SANTE, ST=Paris (75), C=FR\"},{\"idSignConf\":6,\"description\":\"Scheduling Test.\",\"signaturePackaging\":\"ENVELOPING\",\"digestAlgorithm\":\"SHA512\",\"canonicalisationAlgorithm\":\"http://www.w3.org/2001/10/xml-exc-c14n#\",\"dn\":\"CN=tomwsrevoque.henix.asipsante.fr, OU=318751275100020, O=ASIP-SANTE, ST=Paris (75), C=FR\"}],\"signatureVerification\":[{\"idVerifSignConf\":1,\"description\":\"\",\"rules\":[{\"id\":\"FormatSignature\",\"description\":\"Le format de signature est correct (Xades Baseline B, XMlDsig-core-1).\"},{\"id\":\"SignatureCertificatValide\",\"description\":\"La signature du certificat est valide.\"},{\"id\":\"ExistenceBaliseSigningTime\",\"description\":\"La balise 'SigningTime' existe dans la signature.\"},{\"id\":\"ExistenceDuCertificatDeSignature\",\"description\":\"Le certificat utilisé pour la signature existe dans la signature.\"},{\"id\":\"ExpirationCertificatSignature\",\"description\":\"Pas de description\"},{\"id\":\"NonRepudiation\",\"description\":\"L'usage de la clé du certificat correspond à un usage de signature électronique et de non répudiation.\"},{\"id\":\"RevocationCertificat\",\"description\":\"Le certificat n'est pas révoqué.\"},{\"id\":\"SignatureNonVide\",\"description\":\"La signature existe et n'est pas vide.\"},{\"id\":\"TrustedCertificat\",\"description\":\"L'autorité de Certification est reconnue.\"},{\"id\":\"SignatureIntacte\",\"description\":\"La signature est intacte.\"},{\"id\":\"DocumentIntacte\",\"description\":\"Le document est intacte.\"}],\"metaData\":[\"DATE_SIGNATURE\",\"DN_CERTIFICAT\",\"RAPPORT_DIAGNOSTIQUE\",\"DOCUMENT_ORIGINAL_NON_SIGNE\"]},{\"idVerifSignConf\":2,\"description\":\"\",\"rules\":[{\"id\":\"SignatureCertificatValide\",\"description\":\"La signature du certificat est valide.\"},{\"id\":\"ExistenceBaliseSigningTime\",\"description\":\"La balise 'SigningTime' existe dans la signature.\"},{\"id\":\"ExistenceDuCertificatDeSignature\",\"description\":\"Le certificat utilisé pour la signature existe dans la signature.\"},{\"id\":\"NonRepudiation\",\"description\":\"L'usage de la clé du certificat correspond à un usage de signature électronique et de non répudiation.\"},{\"id\":\"RevocationCertificat\",\"description\":\"Le certificat n'est pas révoqué.\"},{\"id\":\"SignatureNonVide\",\"description\":\"La signature existe et n'est pas vide.\"},{\"id\":\"TrustedCertificat\",\"description\":\"L'autorité de Certification est reconnue.\"},{\"id\":\"SignatureIntacte\",\"description\":\"La signature est intacte.\"},{\"id\":\"DocumentIntacte\",\"description\":\"Le document est intacte.\"}],\"metaData\":[]}],\"certificatVerification\":[{\"idVerifCertConf\":1,\"description\":\"\",\"rules\":[{\"id\":\"ExpirationCertificat\",\"description\":\"Le certificat n'est pas expiré.\"},{\"id\":\"RevocationCertificat\",\"description\":\"Le certificat n'est pas révoqué.\"},{\"id\":\"SignatureCertificatValide\",\"description\":\"La signature du certificat est valide.\"},{\"id\":\"TrustedCertificat\",\"description\":\"L'autorité de Certification est reconnue.\"}],\"metaData\":[\"DN_CERTIFICAT\",\"RAPPORT_DIAGNOSTIQUE\"]},{\"idVerifCertConf\":2,\"description\":\"\",\"rules\":[{\"id\":\"ExpirationCertificat\",\"description\":\"Le certificat n'est pas expiré.\"},{\"id\":\"RevocationCertificat\",\"description\":\"Le certificat n'est pas révoqué.\"},{\"id\":\"SignatureCertificatValide\",\"description\":\"La signature du certificat est valide.\"},{\"id\":\"TrustedCertificat\",\"description\":\"L'autorité de Certification est reconnue.\"}],\"metaData\":[]}],\"proof\":[{\"idProofConf\":1,\"description\":\"Fichier par défaut pour la preuve\",\"digestAlgorithmForProof\":\"SHA256\",\"canonicalisationAlgorithmForProof\":\"http://www.w3.org/2001/10/xml-exc-c14n#\",\"dn\":\"CN=testsign.test.asipsante.fr, OU=318751275100020, O=ASIP-SANTE, ST=Paris (75), C=FR\"},{\"idProofConf\":2,\"description\":\"Configuration de Ioanna pour la preuve\",\"digestAlgorithmForProof\":\"SHA256\",\"canonicalisationAlgorithmForProof\":\"http://www.w3.org/2001/10/xml-exc-c14n#\",\"dn\":\"CN=asipsign.preuve.henix.asipsante.fr, OU=318751275100020, O=ASIP-SANTE, ST=Paris (75), C=FR\"},{\"idProofConf\":5,\"description\":\"Fichier par défaut pour la preuve\",\"digestAlgorithmForProof\":\"SHA256\",\"canonicalisationAlgorithmForProof\":\"http://www.w3.org/2001/10/xml-exc-c14n#\",\"dn\":\"CN=\\\"rpps.tra.henix;asipsante.fr\\\", OU=318751275100020, O=ASIP-SANTE, ST=Paris (75), C=FR\"},{\"idProofConf\":6,\"description\":\"Fichier par défaut pour la preuve\",\"digestAlgorithmForProof\":\"SHA256\",\"canonicalisationAlgorithmForProof\":\"http://www.w3.org/2001/10/xml-exc-c14n#\",\"dn\":\"CN=tomwsrevoque.henix.asipsante.fr, OU=318751275100020, O=ASIP-SANTE, ST=Paris (75), C=FR\"},{\"idProofConf\":7,\"description\":\"Fichier par défaut pour la preuve\",\"digestAlgorithmForProof\":\"SHA256\",\"canonicalisationAlgorithmForProof\":\"http://www.w3.org/2001/10/xml-exc-c14n#\",\"dn\":\"CN=mock.platines.henix.asipsante.fr, OU=318751275100020, O=ASIP-SANTE, ST=Paris (75), C=FR\"}]}";
