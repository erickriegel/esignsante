...
public class SignatureApiIntegrationTest {
    ...
    public void init() throws Exception {
        xml = new MockMultipartFile("file",
                Thread.currentThread().getContextClassLoader()
                        .getResourceAsStream(
                                "Fichier_TOMWS2_SANS_SIGNATURE.xml"));

        texte = new MockMultipartFile("file", Thread.currentThread()
                .getContextClassLoader().getResourceAsStream("outerjoint.txt"));
        assertNotNull(xml);
        assertNotNull(texte);
    }
    ...
    public void signatureXMLdsigCertExpire() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.fileUpload("/signatures/xmldsig")
                .file(xml).param("idSignConf", "5").accept("application/json"))
                .andExpect(status().isServiceUnavailable()).andDo(print());
    }

    /**
     * Cas non passant de signature XMLDSIG avec preuve avec un certificat
     * expiré
     *
     * @throws Exception
     *             the exception
    ...
    public void signatureXMLdsigWithProofCertExpire() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/signatures/xmldsigwithproof").file(xml)
                .param("idSignConf", "1").param("idVerifSignConf", "1")
                .param("requestId", "Request-1").param("proofTag", "MonTAG")
                .param("applicantId", "RPPS").param("idProofConf", "5")
    ...
    public void signatureXMLdsigCertRevoque() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.fileUpload("/signatures/xmldsig")
                .file(xml).param("idSignConf", "6").accept("application/json"))
                .andExpect(status().isServiceUnavailable()).andDo(print());
    }
    ...
    public void signatureXMLdsigWithProofCertRevoque() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .param("idSignConf", "1").param("idVerifSignConf", "1")
                .param("requestId", "Request-1").param("proofTag", "MonTAG")
                .param("applicantId", "RPPS").param("idProofConf", "6")
                .accept("application/json"))
                .andExpect(status().isServiceUnavailable()).andDo(print());
    }
    ...
    public void signatureXMLdsigWithProofCertBadUsage() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                ...
                .param("idSignConf", "1").param("idVerifSignConf", "1")
                .param("requestId", "Request-1").param("proofTag", "MonTAG")
                .param("applicantId", "RPPS").param("idProofConf", "7")
                .accept("application/json"))
                .andExpect(status().isServiceUnavailable()).andDo(print());
    }
    ...
    public void signatureXMLdsigTestNoProof() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders.fileUpload("/signatures/xmldsig")
                .file(xml).param("idSignConf", "1").accept("application/json"))
    ...
    public void signatureXMLdsigTestWrongAllIds() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/signatures/xmldsigwithproof").file(xml)
                .param("idSignConf", "100").param("idVerifSignConf", "100")
                .param("requestId", "Request-1").param("proofTag", "MonTAG")
                .param("applicantId", "RPPS").param("idProofConf", "100")
                .accept("application/json")).andExpect(status().isNotFound())
                .andDo(print());
    }

    /**
     * Erreur 501. Cas d'une demande de signature d'un fichier non XML
     * enveloppée
     *
     * @throws Exception
     *             the exception
    ...
    public void signatureXMLdsigTestWrongFileFormat() throws Exception {
        ...
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/signatures/xmldsigwithproof").file(texte)
                .param("idSignConf", "3").param("idVerifSignConf", "1")
                .param("requestId", "Request-1").param("proofTag", "MonTAG")
    ...
    public void signatureXadesTest() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/signatures/xadesbaselineb").file(xml)
    ...
    public void signatureXadesTestWrongId() throws Exception {
        mockMvc.perform(MockMvcRequestBuilders
                .fileUpload("/signatures/xadesbaselineb").file(xml)
                .param("idSignConf", "100").accept("application/json"))
